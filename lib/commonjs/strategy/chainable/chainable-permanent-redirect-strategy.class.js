...
var ChainablePermanentRedirectStrategy = /*#__PURE__*/function (_ChainableStrategy) {
  (0, _inherits2["default"])(ChainablePermanentRedirectStrategy, _ChainableStrategy);
  ...
  function ChainablePermanentRedirectStrategy(data) {
    ...
    (0, _classCallCheck2["default"])(this, ChainablePermanentRedirectStrategy);
    _this = _super.call(this);
    _this.data = data;
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "type", _strategy.StrategyType.PERMANENT_REDIRECT);
    return _this;
  }

  (0, _createClass2["default"])(ChainablePermanentRedirectStrategy, [{
    key: "serialize",
